...
public class LocomotionController : StateMachineBehaviour {
    ...
    void Start()
    {
        ...
        script = vampire.GetComponent<VampireScript>();
    ...
    public override void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        vertical = Input.GetAxis("Vertical");
        horizontal = Input.GetAxis("Horizontal");
        speed = Mathf.Sqrt((vertical * vertical) + (horizontal * horizontal));
        ...
        animator.SetFloat(m_HashJumpPara, jump);
        ...
        animator.SetFloat(m_HashSpeedPara, speed, m_Damping, Time.deltaTime);
    }
}
